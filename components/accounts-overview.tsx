    ...
    <div className="max-w-3xl mx-auto space-y-6">
      <BankingCard>
        <div className="space-y-6">
          <div>
            <h2 className="text-2xl font-bold text-neutral-900">Your Accounts</h2>
            <p className="text-neutral-600 mt-1">Overview of all your accounts</p>
          </div>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      {account.apy && (
                        <p className="text-sm text-secondary-main mt-1">
                          {account.apy}% APY
                        </p>
                      )}
                    </div>
                  ...
                  <div className="text-right">
                    ...
                    {account.trend && (
                      <p className={`text-sm ${account.trend > 0 ? "text-secondary-main" : "text-error"}`}>
          ...
          <button className="w-full p-3 border border-primary-main text-primary-main rounded-lg hover:bg-primary-main/5 transition-colors">
            Open New Account
          </button>
        </div>
      </BankingCard>
