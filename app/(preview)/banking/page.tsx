...
export default function Banking() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-neutral-50 dark:bg-neutral-500">
      <Header currentPage="banking" />
      ...
      <div className="flex flex-row justify-center pb-20 h-dvh">
        <div className="flex flex-col justify-between gap-4">
          ...
          >
            {!hasUserInteracted && (
              <motion.div className="min-h-[200px] px-4 w-full md:w-[500px] md:px-0 pt-8">
                <div className="border rounded-lg p-6 flex flex-col gap-4 text-neutral-400 text-sm dark:text-neutral-200 dark:border-neutral-400">
                  <p className="text-center text-2xl font-medium text-neutral-500 dark:text-neutral-50 relative inline-block">
                    Welcome to Your Bank Assist
                    <AutoAwesomeIcon 
                      className="absolute -top-2 text-primary text-2xl animate-pulse" 
                    />
                  </p>
                  <p>
              ...
              suggestedActions.map((action, index) => (
                ...
                >
                  <button
                    ...
                    className="w-full text-left border border-neutral-200 dark:border-neutral-400 text-neutral-500 dark:text-neutral-200 rounded-lg p-4 text-sm hover:bg-neutral-200 hover:text-neutral-500 dark:hover:bg-neutral-400 transition-colors flex flex-col gap-2"
                  >
          ...
          >
            <input
              ref={inputRef}
              className="bg-neutral-200 rounded-md px-4 py-3 w-full outline-none focus:ring-2 focus:ring-primary focus:ring-opacity-100 dark:focus:ring-primary dark:focus:ring-opacity-100 dark:bg-neutral-400 text-neutral-500 dark:text-neutral-50 md:max-w-[500px] max-w-[calc(100dvw-32px)] placeholder:text-neutral-400 dark:placeholder:text-neutral-200"
